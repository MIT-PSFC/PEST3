...
#include <map>
#include <list>
#include "preact/transp_util.h"
#include "preact/fwrap.h"
#include "preact/gatekeeper.h"
...
// is implemented, compile with '-std=gnu++0x' or '-std=c++0x'.  In TRANSP, this can be done
