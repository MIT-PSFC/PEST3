!----------------------------------------------------------
! r8real -- generated (f90 fixed form) REAL interface to:  EQ_AREA
      SUBROUTINE R4_EQ_AREA(
...
! allocation of working arrays...
     ...
     >  ' ?R4_EQ_AREA -- ZRHO_act ALLOCATE error!')
      ALLOCATE(ZVAL_act(IVEC)
     >   ,stat=alloc_stat)
      if(alloc_stat.ne.0) call errmsg_exit(
     >  ' ?R4_EQ_AREA -- ZVAL_act ALLOCATE error!')
 
! executable code:  copy for input
 
      ZRHO_act=R4_ZRHO
      ZVAL_act=0
! call to original routine:  EQ_AREA
