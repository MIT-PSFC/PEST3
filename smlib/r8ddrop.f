...
C------------------------------------------------------------
C
      SUBROUTINE r8ddrop(X,Y,N,DDV,NDROP)
C
...
C idecl:  explicitize implicit INTEGER declarations:
      ...
      INTEGER n,ndrop,nm1,na1,na2,i,im1,ip1,nv1,j,nv2,nviol,nv,nvc,iv,
     > ncm1,ncp1,nam1,np1
C============
C idecl:  explicitize implicit REAL declarations:
      REAL*8 y,ddv,x,dytes,ylinin,xx,x1,y1,x2,y2,ysav,dynew
C============
