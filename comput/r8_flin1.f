...
C
      REAL*8 FUNCTION r8_flin1(NOUT,ARRAY,X,IDENT,XMIN,XMAX,XLR,NX)
c
...
! idecl:  explicitize implicit INTEGER declarations:
      IMPLICIT NONE
      INTEGER ident,nx,nout,jdent,ipxl,ipyl,ipxh,ipyh,ix,ixp1
!============
! idecl:  explicitize implicit REAL declarations:
      REAL*8 array,x,xmin,xmax,xlr,zx,zy,zzx,zlogx
!============
      DIMENSION ARRAY(NX)
C
      COMMON/R8ZFLINT/ ZX,ZY,JDENT,IPXL,IPYL,IPXH,IPYH
C
      external r8zcflnt            ! block data initialization
C
...
C  INTERPOLATE
C
      r8_flin1=(1.0D0-ZZX)*ARRAY(IX)+ZZX*ARRAY(IXP1)
C
      RETURN
      	END
C
...
! idecl:  explicitize implicit INTEGER declarations:
      IMPLICIT NONE
      INTEGER jdent,ipxl,ipyl,ipxh,ipyh
!============
! idecl:  explicitize implicit REAL declarations:
      REAL*8 zx,zy
!============
