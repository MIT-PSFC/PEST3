...
C***DESCRIPTION
C
C   TR_DSORT sorts array DX and optionally makes the same interchanges in
...
C     .. Intrinsic Functions ..
      INTRINSIC ABS, INT
C***FIRST EXECUTABLE STATEMENT  TR_DSORT
      NN = N
      IF (NN .LT. 1) THEN
