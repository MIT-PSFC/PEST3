...
program drive
  ...
  if(ier/=0) call err_count('**ERROR** after spline1_not')
  write(0,*)'>> periodic boundary conditions'
  call spline1_per(ier)
  if(ier/=0) call err_count('**ERROR** after spline1_per')
  write(0,*)'>> 1st derivative boundary conditions'
  call spline1_1st(ier)
  if(ier/=0) call err_count('**ERROR** after spline1_1st')
  write(0,*)'>> 2nd derivative boundary conditions'
  call spline1_2nd(ier)
  if(ier/=0) call err_count('**ERROR** after spline1_2nd')
  ...
  if(ier/=0) call err_count('**ERROR** after spline2_not')
  write(0,*)'>> periodic boundary conditions'
  call spline2_per(ier)
  if(ier/=0) call err_count('**ERROR** after spline2_per')
  write(0,*)'>> mixed boundary conditions'
  call spline2_mix(ier)
  if(ier/=0) call err_count('**ERROR** after spline2_mix')
  ...
  if(ier/=0) call err_count('**ERROR** after spline3_mix')
  write(0,*)'>> mixed boundary conditions 2'
  call spline3_mox(ier)
  if(ier/=0) call err_count('**ERROR** after spline3_mox')

  write(0,*)''
  write(0,*)'> 1-D Akima Hermite'
  write(0,*)''
  call akima1_not(ier)
  if(ier/=0) call err_count('**ERROR** after akima1_not')
  write(0,*)'>> periodic boundary conditions'
  call akima1_per(ier)
  if(ier/=0) call err_count('**ERROR** after akima1_per')

  write(0,*)''
  write(0,*)'> 2-D Akima Hermite'
  write(0,*)''
  call akima2_not(ier)
  if(ier/=0) call err_count('**ERROR** after akima2_not')
  write(0,*)'>> periodic boundary conditions'
  call akima2_per(ier)
  if(ier/=0) call err_count('**ERROR** after akima2_per')
  ...
  write(0,*)'>> mixed boundary conditions'
  call akima3_mix(ier)
  if(ier/=0) call err_count('**ERROR** after akima3_mix')
